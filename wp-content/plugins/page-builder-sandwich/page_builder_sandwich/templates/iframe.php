...
<head>
	...
	<title><?php esc_html_e( 'Page Builder Sandwich', PAGE_BUILDER_SANDWICH ) . ' | ' . get_the_title(); ?></title>
	<?php
...
<body class="pbs-iframe" data-scroll="0">
	<div id="pbs-iframe-controls">
		...
		<div class="pbs-iframe-note"><?php esc_html_e( 'You are in responsive view mode with limited editing capabilities. Some of your changes will only apply to smaller screens.', PAGE_BUILDER_SANDWICH ) ?> <a href="#">Learn more</a></div>
		<div class="pbs-save">
			<div class="pbs-buttons">
				<div class="pbs-hide-elements"><?php esc_html_e( 'Toggle hidden elements', PAGE_BUILDER_SANDWICH ) ?></div>
			</div>
		</div>
	</div>
