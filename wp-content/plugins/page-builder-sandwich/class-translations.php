	...
	class PBSTranslations {
		...
		public function add_labels( $args ) {
			...
			$args['labels'] = array(
				...
				'convert_to_even_3_columns' => sprintf( __( 'Convert to %s', PAGE_BUILDER_SANDWICH ), sprintf( __( 'Even %d Columns', PAGE_BUILDER_SANDWICH ), 2 ) ),
				'convert_to_uneven_3_columns' => sprintf( __( 'Convert to %s', PAGE_BUILDER_SANDWICH ), sprintf( __( 'Uneven %d Columns', PAGE_BUILDER_SANDWICH ), 2 ) ),
				'convert_to_even_4_columns' => sprintf( __( 'Convert to %s', PAGE_BUILDER_SANDWICH ), sprintf( __( 'Even %d Columns', PAGE_BUILDER_SANDWICH ), 2 ) ),
				'convert_to_uneven_4_columns' => sprintf( __( 'Convert to %s', PAGE_BUILDER_SANDWICH ), sprintf( __( 'Uneven %d Columns', PAGE_BUILDER_SANDWICH ), 2 ) ),
