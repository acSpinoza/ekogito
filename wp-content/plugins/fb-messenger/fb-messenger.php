...
<div id="fbMsg<?php if (get_option('fb_messenger_left_side') == true) { ?>-leftside<?php } ?>">
	<img data-remodal-target="fb-messenger" src="<?php echo plugins_url( 'images/fb-messenger.png', __FILE__ ) ?>">
</div>
<?php }//hide_button ?>
