...
<script type="text/javascript">
	var WpFcExcludePages = {
		...
		reorder: function(type){
			jQuery("div.wpfc-exclude-page-list div.wpfc-exclude-item").each(function(i, e){
			...
			jQuery("div.wpfc-exclude-useragent-list div.wpfc-exclude-item").each(function(i, e){
				jQuery(e).removeClass("wpfc-exclude-item-right");
