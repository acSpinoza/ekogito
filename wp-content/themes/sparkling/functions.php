...
function add_my_script() {
  ...
  wp_enqueue_script(
    'infinite_scroll',
    get_template_directory_uri() . '/inc/js/jquery.infinitescroll.js', 
    array('jquery')
  );
  wp_enqueue_script(
    'isotope',
    get_template_directory_uri() . '/inc/js/isotope.pkgd.min.js',
    array('jquery')
  );
}   
...
function custom_infinite_scroll_js() {
  ...
  var infinite_scroll = {
    loading: {
      img: "<?php echo get_template_directory_uri(); ?>/inc/images/ajax-loader.gif",
